  ...
  return (
    <>
      ...
      <div className="wrap">
        ...
        <footer className="note">Developed by Andres Gil and Juan Andrés Lopez in collaboration with Universidad Central de Venezuela (UCV). 26/6/2026 - 0412-6127323</footer>
      </div>
      <Analytics />
      <SpeedInsights />
    </>
